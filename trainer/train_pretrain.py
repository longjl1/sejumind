# 从dataset 获取input_ids, labels, attention_mask
# 向前传播，计算loss
# 反向传播，更新参数
...
from model.model import SejuMindConfig  # 模型定义
...
def train_epoch(epoch, loader, iters, start_step=0, wandb=None):
    ...
    for step, (input_ids, labels, attention_mask) in enumerate(
        ...
        scaler.scale(loss).backward()  # 反向传播，缩放梯度以稳定训练
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SejuMind Pretraining")
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="SejuMind-Pretrain", help="wandb项目名"
    )
